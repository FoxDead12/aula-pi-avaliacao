...
export class init1669827437899 implements MigrationInterface {
    name = 'init1669827437899'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`HorarioTurma\` (\`id\` int NOT NULL, \`diaSemana\` int NOT NULL, \`disciplina\` varchar(255) NOT NULL, \`sala\` int NOT NULL, \`horaInicio\` varchar(255) NOT NULL, \`horaFim\` varchar(255) NOT NULL, \`turmaId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
